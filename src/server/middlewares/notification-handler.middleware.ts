...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'Order #123 has been placed by Customer X.create': {
    roles: ['business-owner', 'admin'],
    key: 'order_create',
    tenantPath: [],
    userPath: [],
  },
  'Payment for Order #123 has been received.update': {
    roles: ['business-owner', 'admin'],
    key: 'payment_received',
    tenantPath: [],
    userPath: [],
  },
  'Stock for Product Y is low.update': {
    roles: ['business-owner', 'admin'],
    key: 'low_stock',
    tenantPath: [],
    userPath: [],
...
const tenantRoles: string[] = ['business-owner', 'admin'];
