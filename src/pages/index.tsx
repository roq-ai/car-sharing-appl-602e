  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Car Sharing Application - Revolutionizing your commuting experience, one shared journey at a time. Join us and redefine your travel."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Car Sharing Application - Revolutionizing your commuting experience, one shared journey at a time. Join us and redefine your travel.`}
            </Text>
            <Box
